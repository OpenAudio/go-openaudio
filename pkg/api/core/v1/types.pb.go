...
func (x *SignedTransaction) GetRewardPool() *RewardPoolMessage {
	if x, ok := x.GetTransaction().(*SignedTransaction_RewardPool); ok {
		return x.RewardPool
	}
	return nil
}
...
func (x *SignedTransaction) GetManageEntityMigration() *ManageEntityLegacyMigration {
	if x, ok := x.GetTransaction().(*SignedTransaction_ManageEntityMigration); ok {
		return x.ManageEntityMigration
	}
	return nil
}

func (x *SignedTransaction) GetMediorumOperation() *MediorumOperation {
	if x, ok := x.GetTransaction().(*SignedTransaction_MediorumOperation); ok {
		return x.MediorumOperation
	}
	return nil
}

func (x *SignedTransaction) GetContentAttestation() *ContentAttestation {
	if x, ok := x.GetTransaction().(*SignedTransaction_ContentAttestation); ok {
		return x.ContentAttestation
	}
	return nil
}
...
func (*SignedTransaction_RewardPool) isSignedTransaction_Transaction() {}

func (*SignedTransaction_ManageEntityMigration) isSignedTransaction_Transaction() {}

func (*SignedTransaction_MediorumOperation) isSignedTransaction_Transaction() {}

func (*SignedTransaction_ContentAttestation) isSignedTransaction_Transaction() {}
...
// ManageEntityLegacyMigration is structurally identical to ManageEntityLegacy
// but signals to indexers that the transaction was produced by genesis-writer
// during the initial chain migration. Indexers must verify only that the signer
// matches the genesis migration authority; standard ownership, wallet-uniqueness,
// and signer checks must not be applied.
...
func (x *ManageEntityLegacyMigration) ProtoReflect() protoreflect.Message {
	mi := &file_core_v1_types_proto_msgTypes[31]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// RewardBody is the signed payload. deadline_block_height bounds the
// signature's validity (the validator rejects after expiry); the action
// is the actual operation. The oneof tag discriminates Create from
// Delete so two actions with otherwise-identical inner shapes produce
// different bytes.
...
func (x *RewardBody) GetCreate() *CreateReward {
	if x, ok := x.GetAction().(*RewardBody_Create); ok {
		return x.Create
	}
	return nil
}
...
func (x *RewardBody) GetDelete() *DeleteReward {
	if x, ok := x.GetAction().(*RewardBody_Delete); ok {
		return x.Delete
	}
	return nil
}

type isRewardBody_Action interface {
	isRewardBody_Action()
}
...
func (*RewardBody_Create) isRewardBody_Action() {}

func (*RewardBody_Delete) isRewardBody_Action() {}
...
func (x *RewardPoolMessage) GetRmOwnerSignature() []byte {
	if x != nil {
		return x.RmOwnerSignature
	}
	return nil
}

// RewardPoolBody is the signed payload. deadline_block_height bounds the
// signature's validity; action discriminates Create from SetAuthorities
// so two otherwise-identical messages produce different bytes.
//
// Cross-chain replay isn't a threat surface here: each environment's
// launchpad uses a different deterministic secret, so the same
// rewards_manager_pubkey cannot be derived on more than one chain. A
// captured CreateRewardPool replayed on a different chain refers to an
// RM that doesn't exist there.
...
func (x *RewardPoolBody) GetCreate() *CreateRewardPool {
	if x, ok := x.GetAction().(*RewardPoolBody_Create); ok {
		return x.Create
	}
	return nil
}
...
func (x *RewardPoolBody) GetSetAuthorities() *SetRewardPoolAuthorities {
	if x, ok := x.GetAction().(*RewardPoolBody_SetAuthorities); ok {
		return x.SetAuthorities
	}
	return nil
}

type isRewardPoolBody_Action interface {
	isRewardPoolBody_Action()
}
...
func (*RewardPoolBody_Create) isRewardPoolBody_Action() {}

func (*RewardPoolBody_SetAuthorities) isRewardPoolBody_Action() {}
...
// signer must be in the *current* pool.authorities; the new list must be
// non-empty and contain only valid eth addresses (otherwise the pool is
// permanently orphaned). Add and remove are derived views: callers compose
// the new list themselves.
...
// MediorumOperation is the consensus-carried replacement for the legacy CRUDR
// peer gossip operation. It intentionally preserves the old CRUDR data shape:
// action/table identify the GORM model operation, and data is the JSON array
// payload that mediorum already applies to its storage database.
...
// ContentAttestationPayload is what a validator signs to attest that a
// specific wallet uploaded a specific set of bytes to it. Every field the
// attestation speaks about is inside the signed payload, so a recovered
// signature cannot be re-paired with a different uploader, upload, or cid set.
//
// Deliberately separate from FileUpload, which serves DDEX: there the uploader
// signs the original cid, while here they authenticate before any cid exists.
// Sharing one message would mean the same field meaning two different things
// and every rule branching on which mode produced it.
type ContentAttestationPayload struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// lowercased wallet that proved control of itself when the bytes were uploaded
	UploaderAddress string `protobuf:"bytes,1,opt,name=uploader_address,json=uploaderAddress,proto3" json:"uploader_address,omitempty"`
	// cid of the file as uploaded
	OrigCid string `protobuf:"bytes,2,opt,name=orig_cid,json=origCid,proto3" json:"orig_cid,omitempty"`
	// transcoded cid (e.g. 320kbps for audio); empty when not applicable
	TranscodedCid string `protobuf:"bytes,3,opt,name=transcoded_cid,json=transcodedCid,proto3" json:"transcoded_cid,omitempty"`
	// preview cid; empty when the upload has no preview
	PreviewCid string `protobuf:"bytes,4,opt,name=preview_cid,json=previewCid,proto3" json:"preview_cid,omitempty"`
}

func (x *ContentAttestationPayload) Reset() {
	*x = ContentAttestationPayload{}
	if protoimpl.UnsafeEnabled {
...
func (x *ContentAttestationPayload) ProtoReflect() protoreflect.Message {
	mi := &file_core_v1_types_proto_msgTypes[85]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *ContentAttestationPayload) GetUploaderAddress() string {
	if x != nil {
		return x.UploaderAddress
	}
	return ""
...
func (x *ContentAttestationPayload) GetOrigCid() string {
	if x != nil {
		return x.OrigCid
	}
	return ""
...
func (x *ContentAttestationPayload) GetTranscodedCid() string {
	if x != nil {
		return x.TranscodedCid
	}
	return ""
...
func (x *ContentAttestationPayload) GetPreviewCid() string {
	if x != nil {
		return x.PreviewCid
	}
	return ""
...
// ContentAttestation is a validator stating that a wallet uploaded these bytes
// to it. It is what entitles that wallet to name the resulting cids on a
// track, and is the only thing standing between a paywalled master and anyone
// who can read its cid off the public API.
type ContentAttestation struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// wallet entitled to claim the cids below
	UploaderAddress string `protobuf:"bytes,1,opt,name=uploader_address,json=uploaderAddress,proto3" json:"uploader_address,omitempty"`
	OrigCid         string `protobuf:"bytes,2,opt,name=orig_cid,json=origCid,proto3" json:"orig_cid,omitempty"`
	TranscodedCid   string `protobuf:"bytes,3,opt,name=transcoded_cid,json=transcodedCid,proto3" json:"transcoded_cid,omitempty"`
	PreviewCid      string `protobuf:"bytes,4,opt,name=preview_cid,json=previewCid,proto3" json:"preview_cid,omitempty"`
	...
	// validator signature over the marshalled ContentAttestationPayload. This is
	// the load-bearing signature: consensus verifies it and checks the signer is
	// a registered node.
	ValidatorSignature string `protobuf:"bytes,6,opt,name=validator_signature,json=validatorSignature,proto3" json:"validator_signature,omitempty"`
	// The uploader's own EIP-712 signature, as presented to the node. Recorded
	// for dispute forensics and deliberately NOT verified by consensus: it is
	// signed before any cid exists, so it names no content and cannot connect
	// this wallet to these bytes. Only the validator, which saw the bytes arrive
	// over a connection it had authenticated, can make that connection. Its
	// freshness window is also unenforceable here, since an unbounded amount of
	// time passes while transcoding runs.
	UploaderSignature string `protobuf:"bytes,7,opt,name=uploader_signature,json=uploaderSignature,proto3" json:"uploader_signature,omitempty"`
}
...
func (x *ContentAttestation) GetUploaderAddress() string {
	if x != nil {
		return x.UploaderAddress
	}
	return ""
...
func (x *ContentAttestation) GetOrigCid() string {
	if x != nil {
		return x.OrigCid
	}
	return ""
...
func (x *ContentAttestation) GetTranscodedCid() string {
	if x != nil {
		return x.TranscodedCid
	}
	return ""
...
func (x *ContentAttestation) GetPreviewCid() string {
	if x != nil {
		return x.PreviewCid
	}
	return ""
...
func (x *ContentAttestation) GetUploaderSignature() string {
	if x != nil {
		return x.UploaderSignature
	}
	return ""
}
...
func (x *GetDeleteRewardSenderAttestationRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (*GetDeleteRewardSenderAttestationRequest) Descriptor() ([]byte, []int) {
	return file_core_v1_types_proto_rawDescGZIP(), []int{94}
}
...
func (x *GetDeleteRewardSenderAttestationResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (*GetDeleteRewardSenderAttestationResponse) Descriptor() ([]byte, []int) {
	return file_core_v1_types_proto_rawDescGZIP(), []int{95}
}
...
func (x *GetDeleteRewardSenderAttestationResponse) GetAttestation() string {
	if x != nil {
		return x.Attestation
	}
	return ""
...
func (*StreamBlocksRequest) Descriptor() ([]byte, []int) {
	return file_core_v1_types_proto_rawDescGZIP(), []int{96}
}
...
func (*StreamBlocksResponse) Descriptor() ([]byte, []int) {
	return file_core_v1_types_proto_rawDescGZIP(), []int{97}
}
...
func (x *GetStatusResponse_ProcessInfo) GetRestore() *GetStatusResponse_ProcessInfo_ProcessStateInfo {
	if x != nil {
		return x.Restore
	}
	return nil
...
type GetStatusResponse_StorageInfo struct {
	...
	ArchiveIsBlobStorage bool   `protobuf:"varint,8,opt,name=archive_is_blob_storage,json=archiveIsBlobStorage,proto3" json:"archive_is_blob_storage,omitempty"`
...
func (x *GetStatusResponse_StorageInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (*GetStatusResponse_StorageInfo) Descriptor() ([]byte, []int) {
	return file_core_v1_types_proto_rawDescGZIP(), []int{5, 9}
}

func (x *GetStatusResponse_StorageInfo) GetIsBlobStorage() bool {
	if x != nil {
		return x.IsBlobStorage
	}
	return false
}
...
func (x *GetStatusResponse_ProcessInfo_ProcessStateInfo) Reset() {
	*x = GetStatusResponse_ProcessInfo_ProcessStateInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_core_v1_types_proto_msgTypes[108]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *GetStatusResponse_SyncInfo_BlockSyncInfo) Reset() {
	*x = GetStatusResponse_SyncInfo_BlockSyncInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_core_v1_types_proto_msgTypes[110]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *GetStatusResponse_PeerInfo_Peer) Reset() {
	*x = GetStatusResponse_PeerInfo_Peer{}
	if protoimpl.UnsafeEnabled {
		mi := &file_core_v1_types_proto_msgTypes[111]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *GetStreamURLsResponse_EntityStreamURLs) Reset() {
	*x = GetStreamURLsResponse_EntityStreamURLs{}
	if protoimpl.UnsafeEnabled {
		mi := &file_core_v1_types_proto_msgTypes[113]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetStreamURLsResponse_EntityStreamURLs) Descriptor() ([]byte, []int) {
	return file_core_v1_types_proto_rawDescGZIP(), []int{89, 0}
}
...
var file_core_v1_types_proto_rawDesc = []byte{
	...
	0x75, 0x65, 0x73, 0x74, 0x22, 0xc0, 0x2b, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x53, 0x74, 0x61, 0x74,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x63, 0x6f, 0x6d, 0x65, 0x74, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x1f, 0x0a, 0x0b,
	0x65, 0x74, 0x68, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0a, 0x65, 0x74, 0x68, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x1b, 0x0a,
	0x09, 0x6e, 0x6f, 0x64, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x08, 0x6e, 0x6f, 0x64, 0x65, 0x54, 0x79, 0x70, 0x65, 0x1a, 0xa1, 0x01, 0x0a, 0x09, 0x43,
	...
	,
	...
	,
	...
	,
	...
	0x73, 0x1a, 0xe6, 0x03, 0x0a, 0x08, 0x50, 0x65, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x3e,
	0x0a, 0x05, 0x70, 0x65, 0x65, 0x72, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x28, 0x2e,
	0x63, 0x6f, 0x72, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2e, 0x50, 0x65, 0x65, 0x72, 0x49, 0x6e,
	0x66, 0x6f, 0x2e, 0x50, 0x65, 0x65, 0x72, 0x52, 0x05, 0x70, 0x65, 0x65, 0x72, 0x73, 0x1a, 0x99,
	0x03, 0x0a, 0x04, 0x50, 0x65, 0x65, 0x72, 0x12, 0x1a, 0x0a, 0x08, 0x65, 0x6e, 0x64, 0x70, 0x6f,
	...
	,
	...
	,
	...
	0x09, 0x52, 0x0a, 0x65, 0x74, 0x68, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x25, 0x0a,
	0x0e, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x5f, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x18,
	0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0d, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x48, 0x65,
	0x69, 0x67, 0x68, 0x74, 0x22, 0x29, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b,
	...
	,
	...
	0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x63, 0x6f, 0x72, 0x65,
	0x2e, 0x76, 0x31, 0x2e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65,
	0x3a, 0x02, 0x38, 0x01, 0x22, 0x30, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x54, 0x72, 0x61, 0x6e, 0x73,
	...
	0x74, 0x78, 0x48, 0x61, 0x73, 0x68, 0x22, 0x50, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x54, 0x72, 0x61,
	0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x12, 0x36, 0x0a, 0x0b, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x76, 0x31, 0x2e,
	0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x0b, 0x74, 0x72, 0x61,
	0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x97, 0x01, 0x0a, 0x16, 0x53, 0x65, 0x6e,
	...
	0x76, 0x31, 0x2e, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x52, 0x0b, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f,
	0x6e, 0x12, 0x3f, 0x0a, 0x0d, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x76, 0x32, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e,
	0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x52, 0x0d, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x76, 0x32, 0x22, 0xa4, 0x01, 0x0a, 0x17, 0x53, 0x65, 0x6e, 0x64, 0x54, 0x72, 0x61, 0x6e, 0x73,
	...
	,
	...
	0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x63,
	...
	,
	...
	0x72, 0x65, 0x12, 0x42, 0x0a, 0x0c, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e,
	...
	,
	...
	0x01, 0x28, 0x09, 0x52, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x48,
	0x0a, 0x0e, 0x64, 0x65, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x76, 0x31,
	0x2e, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x44, 0x65, 0x72, 0x65, 0x67, 0x69,
	0x73, 0x74, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x0e, 0x64, 0x65, 0x72, 0x65, 0x67, 0x69,
	0x73, 0x74, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xde, 0x01, 0x0a, 0x05, 0x42, 0x6c, 0x6f,
	...
	0x73, 0x68, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x68, 0x61, 0x73, 0x68, 0x12, 0x19,
	0x0a, 0x08, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x07, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x49, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x72, 0x6f,
	0x70, 0x6f, 0x73, 0x65, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x70, 0x72, 0x6f,
	0x70, 0x6f, 0x73, 0x65, 0x72, 0x12, 0x38, 0x0a, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x63, 0x69, 0x74, 0x79, 0x18,
	...
	,
	...
	0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1a, 0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61,
	...
	0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x22, 0xf4,
	0x01, 0x0a, 0x1b, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x4c,
	0x65, 0x67, 0x61, 0x63, 0x79, 0x4d, 0x69, 0x67, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x17,
	0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x65, 0x6e, 0x74, 0x69, 0x74,
	...
	0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x22, 0x62, 0x0a, 0x22, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74,
	0x6f, 0x72, 0x4d, 0x69, 0x73, 0x62, 0x65, 0x68, 0x61, 0x76, 0x69, 0x6f, 0x72, 0x44, 0x65, 0x72,
	0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x23, 0x0a, 0x0d, 0x63,
	0x6f, 0x6d, 0x65, 0x74, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01,
	...
	0x0c, 0x52, 0x06, 0x70, 0x75, 0x62, 0x4b, 0x65, 0x79, 0x22, 0xa6, 0x01, 0x0a, 0x0c, 0x53, 0x74,
	0x6f, 0x72, 0x61, 0x67, 0x65, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x12, 0x16, 0x0a, 0x06, 0x68, 0x65,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x28, 0x04, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61,
	...
	,
	...
	0x73, 0x73, 0x12, 0x25, 0x0a, 0x0e, 0x72, 0x65, 0x77, 0x61, 0x72, 0x64, 0x5f, 0x61, 0x64, 0x64,
	0x72, 0x65, 0x73, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x72, 0x65, 0x77, 0x61,
	0x72, 0x64, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x1c, 0x0a, 0x09, 0x73, 0x70, 0x65,
	0x63, 0x69, 0x66, 0x69, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x73, 0x70,
	0x65, 0x63, 0x69, 0x66, 0x69, 0x65, 0x72, 0x12, 0x27, 0x0a, 0x0f, 0x63, 0x6c, 0x61, 0x69, 0x6d,
	0x5f, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0e, 0x63, 0x6c, 0x61, 0x69, 0x6d, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x74, 0x79,
	...
	0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x72, 0x65, 0x77, 0x61, 0x72, 0x64,
	0x5f, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x72, 0x65, 0x77, 0x61, 0x72,
	0x64, 0x49, 0x64, 0x12, 0x27, 0x0a, 0x0f, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x64, 0x65,
	0x63, 0x69, 0x6d, 0x61, 0x6c, 0x73, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0e, 0x61, 0x6d,
	0x6f, 0x75, 0x6e, 0x74, 0x44, 0x65, 0x63, 0x69, 0x6d, 0x61, 0x6c, 0x73, 0x22, 0x56, 0x0a, 0x1c,
	...
	0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x61, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x22, 0xc7, 0x01, 0x0a, 0x13, 0x53, 0x6c, 0x61, 0x73, 0x68, 0x52, 0x65,
	0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x18, 0x0a, 0x07,
	0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x61,
	0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x30, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x72, 0x74, 0x18,
	...
	,
	...
	0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x22, 0x5c, 0x0a, 0x1b, 0x47, 0x65, 0x74, 0x53, 0x6c,
	...
	0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x76,
	0x31, 0x2e, 0x47, 0x65, 0x74, 0x53, 0x6c, 0x61, 0x73, 0x68, 0x41, 0x74, 0x74, 0x65, 0x73, 0x74,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x52, 0x07, 0x72, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x68, 0x0a, 0x1c, 0x47, 0x65, 0x74, 0x53, 0x6c, 0x61, 0x73,
	0x68, 0x41, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x48, 0x0a, 0x0c, 0x61, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x63, 0x6f,
	...
	,
	...
	,
	...
	,
	...
	0x72, 0x65, 0x22, 0xae, 0x01, 0x0a, 0x0a, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x42, 0x6f, 0x64,
	0x79, 0x12, 0x32, 0x0a, 0x15, 0x64, 0x65, 0x61, 0x64, 0x6c, 0x69, 0x6e, 0x65, 0x5f, 0x62, 0x6c,
	...
	0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x30, 0x0a, 0x06, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x18,
	...
	0x69, 0x6f, 0x6e, 0x22, 0xd4, 0x01, 0x0a, 0x0c, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x52, 0x65,
	...
	,
	...
	,
	...
	,
	...
	0x6b, 0x5f, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x13,
	...
	0x65, 0x22, 0x80, 0x01, 0x0a, 0x12, 0x4c, 0x65, 0x67, 0x61, 0x63, 0x79, 0x44, 0x65, 0x6c, 0x65,
	...
	,
	...
	0x09, 0x52, 0x06, 0x74, 0x78, 0x68, 0x61, 0x73, 0x68, 0x22, 0xde, 0x01, 0x0a, 0x11, 0x47, 0x65,
	0x74, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0x18, 0x0a, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x1b, 0x0a, 0x09, 0x72, 0x65, 0x77,
	0x61, 0x72, 0x64, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x72, 0x65,
	0x77, 0x61, 0x72, 0x64, 0x49, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x03,
	...
	0x6e, 0x74, 0x12, 0x2b, 0x0a, 0x11, 0x63, 0x6c, 0x61, 0x69, 0x6d, 0x5f, 0x61, 0x75, 0x74, 0x68,
	0x6f, 0x72, 0x69, 0x74, 0x69, 0x65, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x09, 0x52, 0x10, 0x63,
	0x6c, 0x61, 0x69, 0x6d, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x74, 0x69, 0x65, 0x73, 0x12,
	0x16, 0x0a, 0x06, 0x73, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52,
	...
	0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x22, 0xf3, 0x01, 0x0a, 0x1a, 0x52,
	0x65, 0x77, 0x61, 0x72, 0x64, 0x41, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x32, 0x0a, 0x15, 0x65, 0x74, 0x68,
	0x5f, 0x72, 0x65, 0x63, 0x69, 0x70, 0x69, 0x65, 0x6e, 0x74, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65,
	0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x13, 0x65, 0x74, 0x68, 0x52, 0x65, 0x63,
	...
	,
	...
	,
	...
	0x69, 0x6f, 0x6e, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x05, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74,
	0x61, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0xa9, 0x01,
	0x0a, 0x19, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x41, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x12, 0x29, 0x0a, 0x10, 0x75,
	...
	,
	...
	,
	...
	0x72, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x12, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61,
	0x74, 0x6f, 0x72, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x2d, 0x0a, 0x12,
	0x75, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x65, 0x72, 0x5f, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75,
	0x72, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x11, 0x75, 0x70, 0x6c, 0x6f, 0x61, 0x64,
	0x65, 0x72, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0x71, 0x0a, 0x16, 0x47,
	0x65, 0x74, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x55, 0x52, 0x4c, 0x73, 0x53, 0x69, 0x67, 0x6e,
	0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73,
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74,
	0x61, 0x6d, 0x70, 0x52, 0x09, 0x65, 0x78, 0x70, 0x69, 0x72, 0x65, 0x73, 0x41, 0x74, 0x22, 0x8d,
	0x01, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x55, 0x52, 0x4c, 0x73,
	...
	,
	...
	,
	...
	,
	...
	0x09, 0x52, 0x0b, 0x61, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x79,
	0x0a, 0x27, 0x47, 0x65, 0x74, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x52, 0x65, 0x77, 0x61, 0x72,
	...
	0x65, 0x73, 0x73, 0x12, 0x34, 0x0a, 0x16, 0x72, 0x65, 0x77, 0x61, 0x72, 0x64, 0x73, 0x5f, 0x6d,
	0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x5f, 0x70, 0x75, 0x62, 0x6b, 0x65, 0x79, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x14, 0x72, 0x65, 0x77, 0x61, 0x72, 0x64, 0x73, 0x4d, 0x61, 0x6e, 0x61,
	0x67, 0x65, 0x72, 0x50, 0x75, 0x62, 0x6b, 0x65, 0x79, 0x22, 0x62, 0x0a, 0x28, 0x47, 0x65, 0x74,
	0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x53, 0x65, 0x6e, 0x64,
	...
	,
	...
	0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x63, 0x6f, 0x72, 0x65, 0x2f, 0x76, 0x31,
...
var file_core_v1_types_proto_msgTypes = make([]protoimpl.MessageInfo, 115)
var file_core_v1_types_proto_goTypes = []interface{}{
	...
	(*ManageEntityLegacyMigration)(nil),                    // 33: core.v1.ManageEntityLegacyMigration
	(*ValidatorMisbehaviorDeregistration)(nil),             // 34: core.v1.ValidatorMisbehaviorDeregistration
	(*StorageProof)(nil),                                   // 35: core.v1.StorageProof
	(*StorageProofVerification)(nil),                       // 36: core.v1.StorageProofVerification
	(*Attestation)(nil),                                    // 37: core.v1.Attestation
	(*ValidatorRegistration)(nil),                          // 38: core.v1.ValidatorRegistration
	(*ValidatorDeregistration)(nil),                        // 39: core.v1.ValidatorDeregistration
	(*GetStoredSnapshotsRequest)(nil),                      // 40: core.v1.GetStoredSnapshotsRequest
	(*GetStoredSnapshotsResponse)(nil),                     // 41: core.v1.GetStoredSnapshotsResponse
	(*SnapshotMetadata)(nil),                               // 42: core.v1.SnapshotMetadata
	(*ClaimAuthority)(nil),                                 // 43: core.v1.ClaimAuthority
	(*Reward)(nil),                                         // 44: core.v1.Reward
	(*GetRewardsRequest)(nil),                              // 45: core.v1.GetRewardsRequest
	(*GetRewardsResponse)(nil),                             // 46: core.v1.GetRewardsResponse
	(*GetRewardAttestationRequest)(nil),                    // 47: core.v1.GetRewardAttestationRequest
	(*GetRewardAttestationResponse)(nil),                   // 48: core.v1.GetRewardAttestationResponse
	(*SlashRecommendation)(nil),                            // 49: core.v1.SlashRecommendation
	(*GetSlashAttestationRequest)(nil),                     // 50: core.v1.GetSlashAttestationRequest
	(*GetSlashAttestationResponse)(nil),                    // 51: core.v1.GetSlashAttestationResponse
	(*GetSlashAttestationsRequest)(nil),                    // 52: core.v1.GetSlashAttestationsRequest
	(*GetSlashAttestationsResponse)(nil),                   // 53: core.v1.GetSlashAttestationsResponse
	(*GetERNRequest)(nil),                                  // 54: core.v1.GetERNRequest
	(*GetERNResponse)(nil),                                 // 55: core.v1.GetERNResponse
	(*GetPartyRequest)(nil),                                // 56: core.v1.GetPartyRequest
	(*GetPartyResponse)(nil),                               // 57: core.v1.GetPartyResponse
	(*GetResourceRequest)(nil),                             // 58: core.v1.GetResourceRequest
	(*GetResourceResponse)(nil),                            // 59: core.v1.GetResourceResponse
	(*GetReleaseRequest)(nil),                              // 60: core.v1.GetReleaseRequest
	(*GetReleaseResponse)(nil),                             // 61: core.v1.GetReleaseResponse
	(*GetDealRequest)(nil),                                 // 62: core.v1.GetDealRequest
	(*GetDealResponse)(nil),                                // 63: core.v1.GetDealResponse
	(*GetMEADRequest)(nil),                                 // 64: core.v1.GetMEADRequest
	(*GetMEADResponse)(nil),                                // 65: core.v1.GetMEADResponse
	(*GetPIERequest)(nil),                                  // 66: core.v1.GetPIERequest
	(*GetPIEResponse)(nil),                                 // 67: core.v1.GetPIEResponse
	(*RewardMessage)(nil),                                  // 68: core.v1.RewardMessage
	(*RewardBody)(nil),                                     // 69: core.v1.RewardBody
	(*CreateReward)(nil),                                   // 70: core.v1.CreateReward
	(*DeleteReward)(nil),                                   // 71: core.v1.DeleteReward
	(*RewardPoolMessage)(nil),                              // 72: core.v1.RewardPoolMessage
	(*RewardPoolBody)(nil),                                 // 73: core.v1.RewardPoolBody
	(*CreateRewardPool)(nil),                               // 74: core.v1.CreateRewardPool
	(*SetRewardPoolAuthorities)(nil),                       // 75: core.v1.SetRewardPoolAuthorities
	(*LegacyRewardMessage)(nil),                            // 76: core.v1.LegacyRewardMessage
	(*LegacyCreateReward)(nil),                             // 77: core.v1.LegacyCreateReward
	(*LegacyDeleteReward)(nil),                             // 78: core.v1.LegacyDeleteReward
	(*GetRewardPoolRequest)(nil),                           // 79: core.v1.GetRewardPoolRequest
	(*GetRewardPoolResponse)(nil),                          // 80: core.v1.GetRewardPoolResponse
	(*GetRewardRequest)(nil),                               // 81: core.v1.GetRewardRequest
	(*GetRewardResponse)(nil),                              // 82: core.v1.GetRewardResponse
	(*RewardAttestationSignature)(nil),                     // 83: core.v1.RewardAttestationSignature
	(*UploadSignature)(nil),                                // 84: core.v1.UploadSignature
	(*FileUpload)(nil),                                     // 85: core.v1.FileUpload
	(*MediorumOperation)(nil),                              // 86: core.v1.MediorumOperation
	(*ContentAttestationPayload)(nil),                      // 87: core.v1.ContentAttestationPayload
	(*ContentAttestation)(nil),                             // 88: core.v1.ContentAttestation
	(*GetStreamURLsSignature)(nil),                         // 89: core.v1.GetStreamURLsSignature
	(*GetStreamURLsRequest)(nil),                           // 90: core.v1.GetStreamURLsRequest
	(*GetStreamURLsResponse)(nil),                          // 91: core.v1.GetStreamURLsResponse
	(*GetUploadByCIDRequest)(nil),                          // 92: core.v1.GetUploadByCIDRequest
	(*GetUploadByCIDResponse)(nil),                         // 93: core.v1.GetUploadByCIDResponse
	(*GetRewardSenderAttestationRequest)(nil),              // 94: core.v1.GetRewardSenderAttestationRequest
	(*GetRewardSenderAttestationResponse)(nil),             // 95: core.v1.GetRewardSenderAttestationResponse
	(*GetDeleteRewardSenderAttestationRequest)(nil),        // 96: core.v1.GetDeleteRewardSenderAttestationRequest
	(*GetDeleteRewardSenderAttestationResponse)(nil),       // 97: core.v1.GetDeleteRewardSenderAttestationResponse
	(*StreamBlocksRequest)(nil),                            // 98: core.v1.StreamBlocksRequest
	(*StreamBlocksResponse)(nil),                           // 99: core.v1.StreamBlocksResponse
	(*GetStatusResponse_ProcessInfo)(nil),                  // 100: core.v1.GetStatusResponse.ProcessInfo
	(*GetStatusResponse_NodeInfo)(nil),                     // 101: core.v1.GetStatusResponse.NodeInfo
	(*GetStatusResponse_ChainInfo)(nil),                    // 102: core.v1.GetStatusResponse.ChainInfo
	(*GetStatusResponse_SyncInfo)(nil),                     // 103: core.v1.GetStatusResponse.SyncInfo
	(*GetStatusResponse_PruningInfo)(nil),                  // 104: core.v1.GetStatusResponse.PruningInfo
	(*GetStatusResponse_ResourceInfo)(nil),                 // 105: core.v1.GetStatusResponse.ResourceInfo
	(*GetStatusResponse_MempoolInfo)(nil),                  // 106: core.v1.GetStatusResponse.MempoolInfo
	(*GetStatusResponse_SnapshotInfo)(nil),                 // 107: core.v1.GetStatusResponse.SnapshotInfo
	(*GetStatusResponse_PeerInfo)(nil),                     // 108: core.v1.GetStatusResponse.PeerInfo
	(*GetStatusResponse_StorageInfo)(nil),                  // 109: core.v1.GetStatusResponse.StorageInfo
	(*GetStatusResponse_ProcessInfo_ProcessStateInfo)(nil), // 110: core.v1.GetStatusResponse.ProcessInfo.ProcessStateInfo
	(*GetStatusResponse_SyncInfo_StateSyncInfo)(nil),       // 111: core.v1.GetStatusResponse.SyncInfo.StateSyncInfo
	(*GetStatusResponse_SyncInfo_BlockSyncInfo)(nil),       // 112: core.v1.GetStatusResponse.SyncInfo.BlockSyncInfo
	(*GetStatusResponse_PeerInfo_Peer)(nil),                // 113: core.v1.GetStatusResponse.PeerInfo.Peer
	nil,                                                    // 114: core.v1.GetBlocksResponse.BlocksEntry
	(*GetStreamURLsResponse_EntityStreamURLs)(nil),         // 115: core.v1.GetStreamURLsResponse.EntityStreamURLs
	nil,                                // 116: core.v1.GetStreamURLsResponse.EntityStreamUrlsEntry
	(*v1beta1.Transaction)(nil),        // 117: core.v1beta1.Transaction
	(*v1beta1.TransactionReceipt)(nil), // 118: core.v1beta1.TransactionReceipt
	(*timestamppb.Timestamp)(nil),      // 119: google.protobuf.Timestamp
	(*v1beta11.NewReleaseMessage)(nil), // 120: ddex.v1beta1.NewReleaseMessage
	(*v1beta11.Party)(nil),             // 121: ddex.v1beta1.Party
	(*v1beta11.Resource)(nil),          // 122: ddex.v1beta1.Resource
	(*v1beta11.Release)(nil),           // 123: ddex.v1beta1.Release
	(*v1beta11.Deal)(nil),              // 124: ddex.v1beta1.Deal
	(*v1beta11.MeadMessage)(nil),       // 125: ddex.v1beta1.MeadMessage
	(*v1beta11.PieMessage)(nil),        // 126: ddex.v1beta1.PieMessage
}
var file_core_v1_types_proto_depIdxs = []int32{
	101, // 0: core.v1.GetStatusResponse.node_info:type_name -> core.v1.GetStatusResponse.NodeInfo
	102, // 1: core.v1.GetStatusResponse.chain_info:type_name -> core.v1.GetStatusResponse.ChainInfo
	103, // 2: core.v1.GetStatusResponse.sync_info:type_name -> core.v1.GetStatusResponse.SyncInfo
	104, // 3: core.v1.GetStatusResponse.pruning_info:type_name -> core.v1.GetStatusResponse.PruningInfo
	105, // 4: core.v1.GetStatusResponse.resource_info:type_name -> core.v1.GetStatusResponse.ResourceInfo
	106, // 5: core.v1.GetStatusResponse.mempool_info:type_name -> core.v1.GetStatusResponse.MempoolInfo
	108, // 6: core.v1.GetStatusResponse.peers:type_name -> core.v1.GetStatusResponse.PeerInfo
	107, // 7: core.v1.GetStatusResponse.snapshot_info:type_name -> core.v1.GetStatusResponse.SnapshotInfo
	100, // 8: core.v1.GetStatusResponse.process_info:type_name -> core.v1.GetStatusResponse.ProcessInfo
	109, // 9: core.v1.GetStatusResponse.storage_info:type_name -> core.v1.GetStatusResponse.StorageInfo
	24,  // 10: core.v1.GetBlockResponse.block:type_name -> core.v1.Block
	114, // 11: core.v1.GetBlocksResponse.blocks:type_name -> core.v1.GetBlocksResponse.BlocksEntry
	...
	117, // 14: core.v1.SendTransactionRequest.transactionv2:type_name -> core.v1beta1.Transaction
	25,  // 15: core.v1.SendTransactionResponse.transaction:type_name -> core.v1.Transaction
	118, // 16: core.v1.SendTransactionResponse.transaction_receipt:type_name -> core.v1beta1.TransactionReceipt
	26,  // 17: core.v1.ForwardTransactionRequest.transaction:type_name -> core.v1.SignedTransaction
	117, // 18: core.v1.ForwardTransactionRequest.transactionv2:type_name -> core.v1beta1.Transaction
	38,  // 19: core.v1.GetRegistrationAttestationRequest.registration:type_name -> core.v1.ValidatorRegistration
	38,  // 20: core.v1.GetRegistrationAttestationResponse.registration:type_name -> core.v1.ValidatorRegistration
	39,  // 21: core.v1.GetDeregistrationAttestationRequest.deregistration:type_name -> core.v1.ValidatorDeregistration
	39,  // 22: core.v1.GetDeregistrationAttestationResponse.deregistration:type_name -> core.v1.ValidatorDeregistration
	119, // 23: core.v1.Block.timestamp:type_name -> google.protobuf.Timestamp
	...
	119, // 26: core.v1.Transaction.timestamp:type_name -> google.protobuf.Timestamp
	117, // 27: core.v1.Transaction.transactionv2:type_name -> core.v1beta1.Transaction
	...
	32,  // 31: core.v1.SignedTransaction.manage_entity:type_name -> core.v1.ManageEntityLegacy
	34,  // 32: core.v1.SignedTransaction.validator_deregistration:type_name -> core.v1.ValidatorMisbehaviorDeregistration
	35,  // 33: core.v1.SignedTransaction.storage_proof:type_name -> core.v1.StorageProof
	36,  // 34: core.v1.SignedTransaction.storage_proof_verification:type_name -> core.v1.StorageProofVerification
	37,  // 35: core.v1.SignedTransaction.attestation:type_name -> core.v1.Attestation
	120, // 36: core.v1.SignedTransaction.release:type_name -> ddex.v1beta1.NewReleaseMessage
	68,  // 37: core.v1.SignedTransaction.reward:type_name -> core.v1.RewardMessage
	85,  // 38: core.v1.SignedTransaction.file_upload:type_name -> core.v1.FileUpload
	72,  // 39: core.v1.SignedTransaction.reward_pool:type_name -> core.v1.RewardPoolMessage
	33,  // 40: core.v1.SignedTransaction.manage_entity_migration:type_name -> core.v1.ManageEntityLegacyMigration
	86,  // 41: core.v1.SignedTransaction.mediorum_operation:type_name -> core.v1.MediorumOperation
	88,  // 42: core.v1.SignedTransaction.content_attestation:type_name -> core.v1.ContentAttestation
	29,  // 43: core.v1.TrackPlays.plays:type_name -> core.v1.TrackPlay
	119, // 44: core.v1.TrackPlay.timestamp:type_name -> google.protobuf.Timestamp
	119, // 45: core.v1.SlaRollup.timestamp:type_name -> google.protobuf.Timestamp
	31,  // 46: core.v1.SlaRollup.reports:type_name -> core.v1.SlaNodeReport
	38,  // 47: core.v1.Attestation.validator_registration:type_name -> core.v1.ValidatorRegistration
	39,  // 48: core.v1.Attestation.validator_deregistration:type_name -> core.v1.ValidatorDeregistration
	42,  // 49: core.v1.GetStoredSnapshotsResponse.snapshots:type_name -> core.v1.SnapshotMetadata
	43,  // 50: core.v1.Reward.claim_authorities:type_name -> core.v1.ClaimAuthority
	82,  // 51: core.v1.GetRewardsResponse.rewards:type_name -> core.v1.GetRewardResponse
	119, // 52: core.v1.SlashRecommendation.start:type_name -> google.protobuf.Timestamp
	119, // 53: core.v1.SlashRecommendation.end:type_name -> google.protobuf.Timestamp
	49,  // 54: core.v1.GetSlashAttestationRequest.data:type_name -> core.v1.SlashRecommendation
	50,  // 55: core.v1.GetSlashAttestationsRequest.request:type_name -> core.v1.GetSlashAttestationRequest
	51,  // 56: core.v1.GetSlashAttestationsResponse.attestations:type_name -> core.v1.GetSlashAttestationResponse
	120, // 57: core.v1.GetERNResponse.ern:type_name -> ddex.v1beta1.NewReleaseMessage
	121, // 58: core.v1.GetPartyResponse.party:type_name -> ddex.v1beta1.Party
	122, // 59: core.v1.GetResourceResponse.resource:type_name -> ddex.v1beta1.Resource
	123, // 60: core.v1.GetReleaseResponse.release:type_name -> ddex.v1beta1.Release
	124, // 61: core.v1.GetDealResponse.deal:type_name -> ddex.v1beta1.Deal
	125, // 62: core.v1.GetMEADResponse.mead:type_name -> ddex.v1beta1.MeadMessage
	126, // 63: core.v1.GetPIEResponse.pie:type_name -> ddex.v1beta1.PieMessage
	69,  // 64: core.v1.RewardMessage.body:type_name -> core.v1.RewardBody
	70,  // 65: core.v1.RewardBody.create:type_name -> core.v1.CreateReward
	71,  // 66: core.v1.RewardBody.delete:type_name -> core.v1.DeleteReward
	73,  // 67: core.v1.RewardPoolMessage.body:type_name -> core.v1.RewardPoolBody
	74,  // 68: core.v1.RewardPoolBody.create:type_name -> core.v1.CreateRewardPool
	75,  // 69: core.v1.RewardPoolBody.set_authorities:type_name -> core.v1.SetRewardPoolAuthorities
	77,  // 70: core.v1.LegacyRewardMessage.create:type_name -> core.v1.LegacyCreateReward
	78,  // 71: core.v1.LegacyRewardMessage.delete:type_name -> core.v1.LegacyDeleteReward
	43,  // 72: core.v1.LegacyCreateReward.claim_authorities:type_name -> core.v1.ClaimAuthority
	119, // 73: core.v1.GetStreamURLsSignature.expires_at:type_name -> google.protobuf.Timestamp
	119, // 74: core.v1.GetStreamURLsRequest.expires_at:type_name -> google.protobuf.Timestamp
	116, // 75: core.v1.GetStreamURLsResponse.entity_stream_urls:type_name -> core.v1.GetStreamURLsResponse.EntityStreamUrlsEntry
	24,  // 76: core.v1.StreamBlocksResponse.block:type_name -> core.v1.Block
	110, // 77: core.v1.GetStatusResponse.ProcessInfo.abci:type_name -> core.v1.GetStatusResponse.ProcessInfo.ProcessStateInfo
	110, // 78: core.v1.GetStatusResponse.ProcessInfo.registry_bridge:type_name -> core.v1.GetStatusResponse.ProcessInfo.ProcessStateInfo
	110, // 79: core.v1.GetStatusResponse.ProcessInfo.echo_server:type_name -> core.v1.GetStatusResponse.ProcessInfo.ProcessStateInfo
	110, // 80: core.v1.GetStatusResponse.ProcessInfo.sync_tasks:type_name -> core.v1.GetStatusResponse.ProcessInfo.ProcessStateInfo
	110, // 81: core.v1.GetStatusResponse.ProcessInfo.peer_manager:type_name -> core.v1.GetStatusResponse.ProcessInfo.ProcessStateInfo
	110, // 82: core.v1.GetStatusResponse.ProcessInfo.data_companion:type_name -> core.v1.GetStatusResponse.ProcessInfo.ProcessStateInfo
	110, // 83: core.v1.GetStatusResponse.ProcessInfo.cache:type_name -> core.v1.GetStatusResponse.ProcessInfo.ProcessStateInfo
	110, // 84: core.v1.GetStatusResponse.ProcessInfo.log_sync:type_name -> core.v1.GetStatusResponse.ProcessInfo.ProcessStateInfo
	110, // 85: core.v1.GetStatusResponse.ProcessInfo.state_sync:type_name -> core.v1.GetStatusResponse.ProcessInfo.ProcessStateInfo
	110, // 86: core.v1.GetStatusResponse.ProcessInfo.mempool_cache:type_name -> core.v1.GetStatusResponse.ProcessInfo.ProcessStateInfo
	110, // 87: core.v1.GetStatusResponse.ProcessInfo.restore:type_name -> core.v1.GetStatusResponse.ProcessInfo.ProcessStateInfo
	111, // 88: core.v1.GetStatusResponse.SyncInfo.state_sync:type_name -> core.v1.GetStatusResponse.SyncInfo.StateSyncInfo
	112, // 89: core.v1.GetStatusResponse.SyncInfo.block_sync:type_name -> core.v1.GetStatusResponse.SyncInfo.BlockSyncInfo
	42,  // 90: core.v1.GetStatusResponse.SnapshotInfo.snapshots:type_name -> core.v1.SnapshotMetadata
	113, // 91: core.v1.GetStatusResponse.PeerInfo.peers:type_name -> core.v1.GetStatusResponse.PeerInfo.Peer
	0,   // 92: core.v1.GetStatusResponse.ProcessInfo.ProcessStateInfo.state:type_name -> core.v1.GetStatusResponse.ProcessInfo.ProcessState
	119, // 93: core.v1.GetStatusResponse.ProcessInfo.ProcessStateInfo.started_at:type_name -> google.protobuf.Timestamp
	119, // 94: core.v1.GetStatusResponse.ProcessInfo.ProcessStateInfo.completed_at:type_name -> google.protobuf.Timestamp
	1,   // 95: core.v1.GetStatusResponse.SyncInfo.StateSyncInfo.phase:type_name -> core.v1.GetStatusResponse.SyncInfo.StateSyncInfo.Phase
	42,  // 96: core.v1.GetStatusResponse.SyncInfo.StateSyncInfo.snapshot:type_name -> core.v1.SnapshotMetadata
	119, // 97: core.v1.GetStatusResponse.SyncInfo.StateSyncInfo.started_at:type_name -> google.protobuf.Timestamp
	119, // 98: core.v1.GetStatusResponse.SyncInfo.StateSyncInfo.completed_at:type_name -> google.protobuf.Timestamp
	101, // 99: core.v1.GetStatusResponse.SyncInfo.BlockSyncInfo.head_source:type_name -> core.v1.GetStatusResponse.NodeInfo
	119, // 100: core.v1.GetStatusResponse.SyncInfo.BlockSyncInfo.started_at:type_name -> google.protobuf.Timestamp
	119, // 101: core.v1.GetStatusResponse.SyncInfo.BlockSyncInfo.completed_at:type_name -> google.protobuf.Timestamp
	24,  // 102: core.v1.GetBlocksResponse.BlocksEntry.value:type_name -> core.v1.Block
	115, // 103: core.v1.GetStreamURLsResponse.EntityStreamUrlsEntry.value:type_name -> core.v1.GetStreamURLsResponse.EntityStreamURLs
...
func file_core_v1_types_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_core_v1_types_proto_msgTypes[31].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ManageEntityLegacyMigration); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_core_v1_types_proto_msgTypes[70].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RewardPoolMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_core_v1_types_proto_msgTypes[73].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SetRewardPoolAuthorities); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_core_v1_types_proto_msgTypes[84].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MediorumOperation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_core_v1_types_proto_msgTypes[85].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ContentAttestationPayload); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_core_v1_types_proto_msgTypes[86].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ContentAttestation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_core_v1_types_proto_msgTypes[108].Exporter = func(v interface{}, i int) interface{} {
		...
		file_core_v1_types_proto_msgTypes[110].Exporter = func(v interface{}, i int) interface{} {
		...
		file_core_v1_types_proto_msgTypes[111].Exporter = func(v interface{}, i int) interface{} {
		...
		file_core_v1_types_proto_msgTypes[113].Exporter = func(v interface{}, i int) interface{} {
	...
	file_core_v1_types_proto_msgTypes[24].OneofWrappers = []interface{}{
		...
		(*SignedTransaction_RewardPool)(nil),
		(*SignedTransaction_ManageEntityMigration)(nil),
		(*SignedTransaction_MediorumOperation)(nil),
		(*SignedTransaction_ContentAttestation)(nil),
	}
	file_core_v1_types_proto_msgTypes[35].OneofWrappers = []interface{}{
		(*Attestation_ValidatorRegistration)(nil),
		(*Attestation_ValidatorDeregistration)(nil),
	}
	file_core_v1_types_proto_msgTypes[67].OneofWrappers = []interface{}{
		(*RewardBody_Create)(nil),
		(*RewardBody_Delete)(nil),
	}
	file_core_v1_types_proto_msgTypes[71].OneofWrappers = []interface{}{
		(*RewardPoolBody_Create)(nil),
		(*RewardPoolBody_SetAuthorities)(nil),
	}
	file_core_v1_types_proto_msgTypes[74].OneofWrappers = []interface{}{
		(*LegacyRewardMessage_Create)(nil),
		(*LegacyRewardMessage_Delete)(nil),
	}
	file_core_v1_types_proto_msgTypes[101].OneofWrappers = []interface{}{
