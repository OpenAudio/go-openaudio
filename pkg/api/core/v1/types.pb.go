...
// ContentAttestationPayload is what a validator signs to attest that a user
// uploaded a set of bytes to it. Every field the attestation speaks about is
// inside the signed payload, so a recovered signature cannot be re-paired with
// a different user or cid set.
//
// Separate from FileUpload, which serves DDEX: there the uploader signs the
// original cid, here they authenticate before any cid exists. One message would
// mean the same field meaning two things and every rule branching on which.
type ContentAttestationPayload struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// user the content belongs to, taken from the uploader's signed request.
	// This is the authorization key, not the uploading wallet: a developer app is
	// a shared wallet, so authorizing everyone who can act for it would let any
	// of its users claim any other's content.
	UserId int64 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	// cids this attestation covers, in the order sent
	Cids []string `protobuf:"bytes,2,rep,name=cids,proto3" json:"cids,omitempty"`
	// lowercased so the two sides cannot disagree over EIP-55 checksum casing.
	// Signed even though consensus does not authorize on it, so the forensic
	// record is the validator's word and not rewritable in transit.
	UploaderAddress string `protobuf:"bytes,3,opt,name=uploader_address,json=uploaderAddress,proto3" json:"uploader_address,omitempty"`
}
...
// ContentAttestation is a validator stating that a user uploaded these bytes to
// it, which is what entitles that user to name the cids on a track.
//
// Deliberately says nothing about what each cid is. The original, the transcode
// and the preview are all just bytes the uploader possessed; whether a cid is a
// track's audio or its preview is track metadata, and consensus never asks.
// Keeping roles out also means an attestation can be sent whenever a cid comes
// into existence rather than only once — previews in particular can be
// regenerated long after upload, and a single fixed-shape attestation would
// leave those cids unclaimable.
type ContentAttestation struct {
	...
	// signature over the marshalled ContentAttestationPayload. This is the
	// load-bearing one: consensus verifies it and checks the signer is registered.
	...
	// wallet that performed the upload, and the EIP-712 signature it presented.
	// Both are kept for dispute forensics and deliberately NOT verified by
	// consensus: the signature is produced before any cid exists, so it names no
	// content and cannot connect a wallet to these bytes — only the validator
	// that received them can. Its freshness window is also unenforceable here,
	// since transcoding takes an unbounded amount of time.
	UploaderAddress   string `protobuf:"bytes,5,opt,name=uploader_address,json=uploaderAddress,proto3" json:"uploader_address,omitempty"`
	UploaderSignature string `protobuf:"bytes,6,opt,name=uploader_signature,json=uploaderSignature,proto3" json:"uploader_signature,omitempty"`
}
...
var file_core_v1_types_proto_rawDesc = []byte{
	...
	0x61, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x73, 0x0a,
	0x19, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x41, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73,
	0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x75, 0x73, 0x65,
	0x72, 0x49, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x63, 0x69, 0x64, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28,
	0x09, 0x52, 0x04, 0x63, 0x69, 0x64, 0x73, 0x12, 0x29, 0x0a, 0x10, 0x75, 0x70, 0x6c, 0x6f, 0x61,
	...
	0x73, 0x73, 0x22, 0xf9, 0x01, 0x0a, 0x12, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x41, 0x74,
	0x74, 0x65, 0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73, 0x65,
	0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72,
	0x49, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x63, 0x69, 0x64, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09,
	0x52, 0x04, 0x63, 0x69, 0x64, 0x73, 0x12, 0x2b, 0x0a, 0x11, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61,
	...
	,
	...
	0x74, 0x22, 0x8d, 0x01, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x55,
	0x52, 0x4c, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x73, 0x69,
	...
	,
	...
	0x75, 0x72, 0x6c, 0x73, 0x12, 0x1f, 0x0a, 0x0b, 0x65, 0x72, 0x6e, 0x5f, 0x61, 0x64, 0x64, 0x72,
	0x65, 0x73, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x65, 0x72, 0x6e, 0x41, 0x64,
	0x64, 0x72, 0x65, 0x73, 0x73, 0x1a, 0x74, 0x0a, 0x15, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x53,
	0x74, 0x72, 0x65, 0x61, 0x6d, 0x55, 0x72, 0x6c, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10,
	...
	,
	...
	0x16, 0x72, 0x65, 0x77, 0x61, 0x72, 0x64, 0x73, 0x5f, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72,
	0x5f, 0x70, 0x75, 0x62, 0x6b, 0x65, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x14, 0x72,
	0x65, 0x77, 0x61, 0x72, 0x64, 0x73, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x50, 0x75, 0x62,
	0x6b, 0x65, 0x79, 0x22, 0x5c, 0x0a, 0x22, 0x47, 0x65, 0x74, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64,
	...
	,
	...
	0x22, 0x4e, 0x0a, 0x13, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x73,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x61, 0x6e, 0x6f, 0x6e,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x05, 0x63, 0x61, 0x6e, 0x6f, 0x6e, 0x12, 0x21, 0x0a,
	...
	0x22, 0x3c, 0x0a, 0x14, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x73,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x24, 0x0a, 0x05, 0x62, 0x6c, 0x6f, 0x63,
	0x6b, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x76,
	0x31, 0x2e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x52, 0x05, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x42, 0x33,
	0x5a, 0x31, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x4f, 0x70, 0x65,
	0x6e, 0x41, 0x75, 0x64, 0x69, 0x6f, 0x2f, 0x67, 0x6f, 0x2d, 0x6f, 0x70, 0x65, 0x6e, 0x61, 0x75,
	0x64, 0x69, 0x6f, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x63, 0x6f, 0x72, 0x65,
