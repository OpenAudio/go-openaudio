...
type CreateRewardPool struct {
	...
	//
	//	"audius:create-reward-pool:" + chain_id + ":" + rewards_manager_pubkey
	//	+ ":" + sorted_lowercased_authorities.join(",")
	//
	// produced by the ed25519 private key whose public key IS
	// rewards_manager_pubkey. Proves possession of the Solana reward
	// manager state account's keypair, which only the legitimate creator
	// (the launchpad relay, deterministically deriving the keypair from
	// (launchpadDeterministicSecret, mint)) holds. Defends against
	// frontrunning where an observer races to register a pool for a
	// freshly-minted RM with attacker-chosen authorities. Required.
...
func (x *CreateRewardPool) GetRmOwnerSignature() []byte {
	if x != nil {
...
var file_core_v1_types_proto_rawDesc = []byte{
	...
	0x98, 0x01, 0x0a, 0x10, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64,
	...
	0x0b, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x74, 0x69, 0x65, 0x73, 0x12, 0x2c, 0x0a, 0x12,
	...
	0x72, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0x72, 0x0a, 0x18, 0x53, 0x65,
	...
	0x65, 0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x79, 0x0a, 0x27, 0x47, 0x65, 0x74, 0x44,
	...
	0x6b, 0x65, 0x79, 0x22, 0x62, 0x0a, 0x28, 0x47, 0x65, 0x74, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65,
	...
	,
