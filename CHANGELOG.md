...
## [1.12.0](https://github.com/OpenAudio/go-openaudio/compare/v1.11.0...v1.12.0) (2026-09-24)


### Features

* **core/storage:** schedule auth enforcement on audius-mainnet-beta and let mediorum follow core's rules ([#572](https://github.com/OpenAudio/go-openaudio/issues/572)) ([ba1c7a8](https://github.com/OpenAudio/go-openaudio/commit/ba1c7a88b61990fcb0c2844729661aaa8e627ed4))
* **core:** let the first assertion of an unclaimed cid take the claim until content auth turns strict ([#577](https://github.com/OpenAudio/go-openaudio/issues/577)) ([a8a108a](https://github.com/OpenAudio/go-openaudio/commit/a8a108a38782feedf4a7d1e7161c5fc1a4f2ab9a))
...
* **storage:** attribute multipart, gRPC, and Go SDK uploads to a user ([#575](https://github.com/OpenAudio/go-openaudio/issues/575)) ([c3aa798](https://github.com/OpenAudio/go-openaudio/commit/c3aa79875c28503b64fcf76bbf7db9cd5603dde2))
...
* **core:** recover canceled block cache subscriptions ([#588](https://github.com/OpenAudio/go-openaudio/issues/588)) ([4ea7527](https://github.com/OpenAudio/go-openaudio/commit/4ea7527a4fe620a3c86c00bf6d37be745dc6bd7d))
* **core:** refuse every CoreService call before core registers ([#582](https://github.com/OpenAudio/go-openaudio/issues/582)) ([6e1bd87](https://github.com/OpenAudio/go-openaudio/commit/6e1bd8721dd0d386c43d9bad8f149c01e16dd15f))
...
* **storage:** refuse attested uploads while core is still starting ([#581](https://github.com/OpenAudio/go-openaudio/issues/581)) ([320a8bd](https://github.com/OpenAudio/go-openaudio/commit/320a8bd7d131645062bad4c7dc5f80a5d5aebb51))
...
* **storage:** serialize writers of one uploads row so the transcode claim survives replication ([#584](https://github.com/OpenAudio/go-openaudio/issues/584)) ([6c7bd6e](https://github.com/OpenAudio/go-openaudio/commit/6c7bd6ebf92ab4c0b46605a39786631e7bed2fb5))
...
* **core:** cache repeated public Comet monitoring requests ([#585](https://github.com/OpenAudio/go-openaudio/issues/585)) ([c19b407](https://github.com/OpenAudio/go-openaudio/commit/c19b4074b47fff4df865a8dabebc7eacc0f7ebff))
* **core:** read local sync state without full status RPC ([#587](https://github.com/OpenAudio/go-openaudio/issues/587)) ([7a9b137](https://github.com/OpenAudio/go-openaudio/commit/7a9b137da6a478224b04706690f13bb0addb1922))
